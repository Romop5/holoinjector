...
if [ $MACHINE_TYPE = "x86_64" ]; then
    ...
    export LD_PRELOAD=/home/roman/school/diploma-thesis/code/visionEnhancer/build/librepeater.so:/usr/local/lib/x86_64-linux-gnu/apitrace/wrappers/glxtrace.so
