...
{
    const std::unordered_map<GLenum, const std::string> enumLUT = {
    {0x1400,"GL_BYTE"},
    ...
    {0xFFFFFFFF,"GL_ALL_CLIENT_ATTRIB_BITS"},
    ...
    {0x92BE,"GL_PRIMITIVE_BOUNDING_BOX_ARB"},
    {0x9381,"GL_MULTISAMPLE_LINE_WIDTH_RANGE_ARB"},
    {0x9382,"GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY_ARB"},
    {0x140F,"GL_UNSIGNED_INT64_ARB"},
    ...
    {0x9344,"GL_MAX_COMPUTE_VARIABLE_GROUP_INVOCATIONS_ARB"},
    {0x90EB,"GL_MAX_COMPUTE_FIXED_GROUP_INVOCATIONS_ARB"},
    {0x9345,"GL_MAX_COMPUTE_VARIABLE_GROUP_SIZE_ARB"},
    {0x91BF,"GL_MAX_COMPUTE_FIXED_GROUP_SIZE_ARB"},
    ...
    {0x9552,"GL_SPIR_V_BINARY_ARB"},
    {0x140E,"GL_INT64_ARB"},
    {0x8FE9,"GL_INT64_VEC2_ARB"},
    {0x8FEA,"GL_INT64_VEC3_ARB"},
    {0x8FEB,"GL_INT64_VEC4_ARB"},
    {0x8FF5,"GL_UNSIGNED_INT64_VEC2_ARB"},
    {0x8FF6,"GL_UNSIGNED_INT64_VEC3_ARB"},
    {0x8FF7,"GL_UNSIGNED_INT64_VEC4_ARB"},
    ...
    {0x8153,"GL_REPLICATE_BORDER"},
    {0x8154,"GL_CONVOLUTION_BORDER_COLOR"},
    {0x80EE,"GL_PARAMETER_BUFFER_ARB"},
    {0x80EF,"GL_PARAMETER_BUFFER_BINDING_ARB"},
    {0x88FE,"GL_VERTEX_ATTRIB_ARRAY_DIVISOR_ARB"},
    {0x8299,"GL_SRGB_DECODE_ARB"},
    {0x9383,"GL_VIEW_CLASS_EAC_R11"},
    {0x9384,"GL_VIEW_CLASS_EAC_RG11"},
    {0x9385,"GL_VIEW_CLASS_ETC2_RGB"},
    {0x9386,"GL_VIEW_CLASS_ETC2_RGBA"},
    {0x9387,"GL_VIEW_CLASS_ETC2_EAC_RGBA"},
    {0x9388,"GL_VIEW_CLASS_ASTC_4x4_RGBA"},
    {0x9389,"GL_VIEW_CLASS_ASTC_5x4_RGBA"},
    {0x938A,"GL_VIEW_CLASS_ASTC_5x5_RGBA"},
    {0x938B,"GL_VIEW_CLASS_ASTC_6x5_RGBA"},
    {0x938C,"GL_VIEW_CLASS_ASTC_6x6_RGBA"},
    {0x938D,"GL_VIEW_CLASS_ASTC_8x5_RGBA"},
    {0x938E,"GL_VIEW_CLASS_ASTC_8x6_RGBA"},
    {0x938F,"GL_VIEW_CLASS_ASTC_8x8_RGBA"},
    {0x9390,"GL_VIEW_CLASS_ASTC_10x5_RGBA"},
    {0x9391,"GL_VIEW_CLASS_ASTC_10x6_RGBA"},
    {0x9392,"GL_VIEW_CLASS_ASTC_10x8_RGBA"},
    {0x9393,"GL_VIEW_CLASS_ASTC_10x10_RGBA"},
    {0x9394,"GL_VIEW_CLASS_ASTC_12x10_RGBA"},
    {0x9395,"GL_VIEW_CLASS_ASTC_12x12_RGBA"},
    ...
    {0x91B1,"GL_COMPLETION_STATUS_ARB"},
    {0x82EE,"GL_VERTICES_SUBMITTED_ARB"},
    {0x82EF,"GL_PRIMITIVES_SUBMITTED_ARB"},
    {0x82F0,"GL_VERTEX_SHADER_INVOCATIONS_ARB"},
    {0x82F1,"GL_TESS_CONTROL_SHADER_PATCHES_ARB"},
    {0x82F2,"GL_TESS_EVALUATION_SHADER_INVOCATIONS_ARB"},
    {0x82F3,"GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED_ARB"},
    {0x82F4,"GL_FRAGMENT_SHADER_INVOCATIONS_ARB"},
    {0x82F5,"GL_COMPUTE_SHADER_INVOCATIONS_ARB"},
    {0x82F6,"GL_CLIPPING_INPUT_PRIMITIVES_ARB"},
    {0x82F7,"GL_CLIPPING_OUTPUT_PRIMITIVES_ARB"},
    ...
    {0x933E,"GL_SAMPLE_LOCATION_PIXEL_GRID_WIDTH_ARB"},
    {0x933F,"GL_SAMPLE_LOCATION_PIXEL_GRID_HEIGHT_ARB"},
    {0x9340,"GL_PROGRAMMABLE_SAMPLE_LOCATION_TABLE_SIZE_ARB"},
    {0x8E50,"GL_SAMPLE_LOCATION_ARB"},
    {0x9341,"GL_PROGRAMMABLE_SAMPLE_LOCATION_ARB"},
    {0x9342,"GL_FRAMEBUFFER_PROGRAMMABLE_SAMPLE_LOCATIONS_ARB"},
    {0x9343,"GL_FRAMEBUFFER_SAMPLE_LOCATION_PIXEL_GRID_ARB"},
    ...
    {0x82F8,"GL_SPARSE_BUFFER_PAGE_SIZE_ARB"},
    {0x91A6,"GL_TEXTURE_SPARSE_ARB"},
    {0x91A7,"GL_VIRTUAL_PAGE_SIZE_INDEX_ARB"},
    {0x91AA,"GL_NUM_SPARSE_LEVELS_ARB"},
    {0x91A8,"GL_NUM_VIRTUAL_PAGE_SIZES_ARB"},
    {0x9195,"GL_VIRTUAL_PAGE_SIZE_X_ARB"},
    {0x9196,"GL_VIRTUAL_PAGE_SIZE_Y_ARB"},
    {0x9197,"GL_VIRTUAL_PAGE_SIZE_Z_ARB"},
    {0x9198,"GL_MAX_SPARSE_TEXTURE_SIZE_ARB"},
    {0x9199,"GL_MAX_SPARSE_3D_TEXTURE_SIZE_ARB"},
    {0x919A,"GL_MAX_SPARSE_ARRAY_TEXTURE_LAYERS_ARB"},
    {0x91A9,"GL_SPARSE_TEXTURE_FULL_ARRAY_CUBE_MIPMAPS_ARB"},
    ...
    {0x9366,"GL_TEXTURE_REDUCTION_MODE_ARB"},
    {0x9367,"GL_WEIGHTED_AVERAGE_ARB"},
    ...
    {0x82EC,"GL_TRANSFORM_FEEDBACK_OVERFLOW_ARB"},
    {0x82ED,"GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW_ARB"},
    ...
    {0x90F3,"GL_CONTEXT_ROBUST_ACCESS"},
    {0x9532,"GL_SUBGROUP_SIZE_KHR"},
    {0x9533,"GL_SUBGROUP_SUPPORTED_STAGES_KHR"},
    {0x9534,"GL_SUBGROUP_SUPPORTED_FEATURES_KHR"},
    {0x9535,"GL_SUBGROUP_QUAD_ALL_STAGES_KHR"},
    ...
    {0x9143,"GL_MAX_DEBUG_MESSAGE_LENGTH_AMD"},
    ...
    {0x91AE,"GL_PIXELS_PER_SAMPLE_PATTERN_X_AMD"},
    {0x91AF,"GL_PIXELS_PER_SAMPLE_PATTERN_Y_AMD"},
    {0xFFFFFFFF,"GL_ALL_PIXELS_AMD"},
    {0x8FF8,"GL_FLOAT16_NV"},
    {0x8FF9,"GL_FLOAT16_VEC2_NV"},
    {0x8FFA,"GL_FLOAT16_VEC3_NV"},
    {0x8FFB,"GL_FLOAT16_VEC4_NV"},
    {0x91C5,"GL_FLOAT16_MAT2_AMD"},
    {0x91C6,"GL_FLOAT16_MAT3_AMD"},
    {0x91C7,"GL_FLOAT16_MAT4_AMD"},
    {0x91C8,"GL_FLOAT16_MAT2x3_AMD"},
    {0x91C9,"GL_FLOAT16_MAT2x4_AMD"},
    {0x91CA,"GL_FLOAT16_MAT3x2_AMD"},
    {0x91CB,"GL_FLOAT16_MAT3x4_AMD"},
    {0x91CC,"GL_FLOAT16_MAT4x2_AMD"},
    {0x91CD,"GL_FLOAT16_MAT4x3_AMD"},
    {0x140E,"GL_INT64_NV"},
    ...
    {0x91A4,"GL_VERTEX_ELEMENT_SWIZZLE_AMD"},
    {0x91A5,"GL_VERTEX_ID_SWIZZLE_AMD"},
    ...
    {0x874F,"GL_OCCLUSION_QUERY_EVENT_MASK_AMD"},
    ...
    {0x9196,"GL_VIRTUAL_PAGE_SIZE_Y_AMD"},
    {0x9197,"GL_VIRTUAL_PAGE_SIZE_Z_AMD"},
    {0x9198,"GL_MAX_SPARSE_TEXTURE_SIZE_AMD"},
    {0x9199,"GL_MAX_SPARSE_3D_TEXTURE_SIZE_AMD"},
    {0x919A,"GL_MAX_SPARSE_ARRAY_TEXTURE_LAYERS"},
    {0x919B,"GL_MIN_SPARSE_LEVEL_AMD"},
    {0x919C,"GL_MIN_LOD_WARNING_AMD"},
    {0x874A,"GL_SET_AMD"},
    {0x874B,"GL_REPLACE_VALUE_AMD"},
    {0x874C,"GL_STENCIL_OP_VALUE_AMD"},
    {0x874D,"GL_STENCIL_BACK_OP_VALUE_AMD"},
    {0x91A0,"GL_STREAM_RASTERIZATION_AMD"},
    ...
    {0x8BB8,"GL_TILE_RASTER_ORDER_FIXED_MESA"},
    {0x8BB9,"GL_TILE_RASTER_ORDER_INCREASING_X_MESA"},
    {0x8BBA,"GL_TILE_RASTER_ORDER_INCREASING_Y_MESA"},
    ...
    {0x954A,"GL_UPLOAD_GPU_MASK_NVX"},
    {0x92BA,"GL_MAX_LGPU_GPUS_NVX"},
    {0x934D,"GL_ALPHA_TO_COVERAGE_DITHER_DEFAULT_NV"},
    {0x934E,"GL_ALPHA_TO_COVERAGE_DITHER_ENABLE_NV"},
    {0x934F,"GL_ALPHA_TO_COVERAGE_DITHER_DISABLE_NV"},
    {0x92BF,"GL_ALPHA_TO_COVERAGE_DITHER_MODE_NV"},
    ...
    {0x0000,"GL_TERMINATE_SEQUENCE_COMMAND_NV"},
    {0x0001,"GL_NOP_COMMAND_NV"},
    {0x0002,"GL_DRAW_ELEMENTS_COMMAND_NV"},
    {0x0003,"GL_DRAW_ARRAYS_COMMAND_NV"},
    {0x0004,"GL_DRAW_ELEMENTS_STRIP_COMMAND_NV"},
    {0x0005,"GL_DRAW_ARRAYS_STRIP_COMMAND_NV"},
    {0x0006,"GL_DRAW_ELEMENTS_INSTANCED_COMMAND_NV"},
    {0x0007,"GL_DRAW_ARRAYS_INSTANCED_COMMAND_NV"},
    {0x0008,"GL_ELEMENT_ADDRESS_COMMAND_NV"},
    {0x0009,"GL_ATTRIBUTE_ADDRESS_COMMAND_NV"},
    {0x000A,"GL_UNIFORM_ADDRESS_COMMAND_NV"},
    {0x000B,"GL_BLEND_COLOR_COMMAND_NV"},
    {0x000C,"GL_STENCIL_REF_COMMAND_NV"},
    {0x000D,"GL_LINE_WIDTH_COMMAND_NV"},
    {0x000E,"GL_POLYGON_OFFSET_COMMAND_NV"},
    {0x000F,"GL_ALPHA_REF_COMMAND_NV"},
    {0x0010,"GL_VIEWPORT_COMMAND_NV"},
    {0x0011,"GL_SCISSOR_COMMAND_NV"},
    {0x0012,"GL_FRONT_FACE_COMMAND_NV"},
    {0x90FB,"GL_COMPUTE_PROGRAM_NV"},
    {0x90FC,"GL_COMPUTE_PROGRAM_PARAMETER_BUFFER_NV"},
    ...
    {0x9379,"GL_CONSERVATIVE_RASTER_DILATE_NV"},
    {0x937A,"GL_CONSERVATIVE_RASTER_DILATE_RANGE_NV"},
    {0x937B,"GL_CONSERVATIVE_RASTER_DILATE_GRANULARITY_NV"},
    ...
    {0x90D0,"GL_MAX_DEEP_3D_TEXTURE_WIDTH_HEIGHT_NV"},
    {0x90D1,"GL_MAX_DEEP_3D_TEXTURE_DEPTH_NV"},
    ...
    {0x92BA,"GL_MULTICAST_GPUS_NV"},
    {0x9558,"GL_RENDER_GPU_MASK_NV"},
    {0x9548,"GL_PER_GPU_STORAGE_NV"},
    {0x9549,"GL_MULTICAST_PROGRAMMABLE_SAMPLE_LOCATION_NV"},
    ...
    {0x95A4,"GL_ATTACHED_MEMORY_OBJECT_NV"},
    {0x95A5,"GL_ATTACHED_MEMORY_OFFSET_NV"},
    {0x95A6,"GL_MEMORY_ATTACHABLE_ALIGNMENT_NV"},
    {0x95A7,"GL_MEMORY_ATTACHABLE_SIZE_NV"},
    {0x95A8,"GL_MEMORY_ATTACHABLE_NV"},
    {0x95A9,"GL_DETACHED_MEMORY_INCARNATION_NV"},
    {0x95AA,"GL_DETACHED_TEXTURES_NV"},
    {0x95AB,"GL_DETACHED_BUFFERS_NV"},
    {0x95AC,"GL_MAX_DETACHED_TEXTURES_NV"},
    {0x95AD,"GL_MAX_DETACHED_BUFFERS_NV"},
    {0x9559,"GL_MESH_SHADER_NV"},
    {0x955A,"GL_TASK_SHADER_NV"},
    {0x8E60,"GL_MAX_MESH_UNIFORM_BLOCKS_NV"},
    {0x8E61,"GL_MAX_MESH_TEXTURE_IMAGE_UNITS_NV"},
    {0x8E62,"GL_MAX_MESH_IMAGE_UNIFORMS_NV"},
    {0x8E63,"GL_MAX_MESH_UNIFORM_COMPONENTS_NV"},
    {0x8E64,"GL_MAX_MESH_ATOMIC_COUNTER_BUFFERS_NV"},
    {0x8E65,"GL_MAX_MESH_ATOMIC_COUNTERS_NV"},
    {0x8E66,"GL_MAX_MESH_SHADER_STORAGE_BLOCKS_NV"},
    {0x8E67,"GL_MAX_COMBINED_MESH_UNIFORM_COMPONENTS_NV"},
    {0x8E68,"GL_MAX_TASK_UNIFORM_BLOCKS_NV"},
    {0x8E69,"GL_MAX_TASK_TEXTURE_IMAGE_UNITS_NV"},
    {0x8E6A,"GL_MAX_TASK_IMAGE_UNIFORMS_NV"},
    {0x8E6B,"GL_MAX_TASK_UNIFORM_COMPONENTS_NV"},
    {0x8E6C,"GL_MAX_TASK_ATOMIC_COUNTER_BUFFERS_NV"},
    {0x8E6D,"GL_MAX_TASK_ATOMIC_COUNTERS_NV"},
    {0x8E6E,"GL_MAX_TASK_SHADER_STORAGE_BLOCKS_NV"},
    {0x8E6F,"GL_MAX_COMBINED_TASK_UNIFORM_COMPONENTS_NV"},
    {0x95A2,"GL_MAX_MESH_WORK_GROUP_INVOCATIONS_NV"},
    {0x95A3,"GL_MAX_TASK_WORK_GROUP_INVOCATIONS_NV"},
    {0x9536,"GL_MAX_MESH_TOTAL_MEMORY_SIZE_NV"},
    {0x9537,"GL_MAX_TASK_TOTAL_MEMORY_SIZE_NV"},
    {0x9538,"GL_MAX_MESH_OUTPUT_VERTICES_NV"},
    {0x9539,"GL_MAX_MESH_OUTPUT_PRIMITIVES_NV"},
    {0x953A,"GL_MAX_TASK_OUTPUT_COUNT_NV"},
    {0x953D,"GL_MAX_DRAW_MESH_TASKS_COUNT_NV"},
    {0x9557,"GL_MAX_MESH_VIEWS_NV"},
    {0x92DF,"GL_MESH_OUTPUT_PER_VERTEX_GRANULARITY_NV"},
    {0x9543,"GL_MESH_OUTPUT_PER_PRIMITIVE_GRANULARITY_NV"},
    {0x953B,"GL_MAX_MESH_WORK_GROUP_SIZE_NV"},
    {0x953C,"GL_MAX_TASK_WORK_GROUP_SIZE_NV"},
    {0x953E,"GL_MESH_WORK_GROUP_SIZE_NV"},
    {0x953F,"GL_TASK_WORK_GROUP_SIZE_NV"},
    {0x9579,"GL_MESH_VERTICES_OUT_NV"},
    {0x957A,"GL_MESH_PRIMITIVES_OUT_NV"},
    {0x957B,"GL_MESH_OUTPUT_TYPE_NV"},
    {0x959C,"GL_UNIFORM_BLOCK_REFERENCED_BY_MESH_SHADER_NV"},
    {0x959D,"GL_UNIFORM_BLOCK_REFERENCED_BY_TASK_SHADER_NV"},
    {0x95A0,"GL_REFERENCED_BY_MESH_SHADER_NV"},
    {0x95A1,"GL_REFERENCED_BY_TASK_SHADER_NV"},
    {0x957C,"GL_MESH_SUBROUTINE_NV"},
    {0x957D,"GL_TASK_SUBROUTINE_NV"},
    {0x957E,"GL_MESH_SUBROUTINE_UNIFORM_NV"},
    {0x957F,"GL_TASK_SUBROUTINE_UNIFORM_NV"},
    {0x959E,"GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_MESH_SHADER_NV"},
    {0x959F,"GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TASK_SHADER_NV"},
    ...
    {0x1407,"GL_2_BYTES_NV"},
    {0x1408,"GL_3_BYTES_NV"},
    {0x1409,"GL_4_BYTES_NV"},
    {0x2400,"GL_EYE_LINEAR_NV"},
    {0x2401,"GL_OBJECT_LINEAR_NV"},
    {0x8576,"GL_CONSTANT_NV"},
    ...
    {0x9540,"GL_QUERY_RESOURCE_TYPE_VIDMEM_ALLOC_NV"},
    {0x9542,"GL_QUERY_RESOURCE_MEMTYPE_VIDMEM_NV"},
    {0x9544,"GL_QUERY_RESOURCE_SYS_RESERVED_NV"},
    {0x9545,"GL_QUERY_RESOURCE_TEXTURE_NV"},
    {0x9546,"GL_QUERY_RESOURCE_RENDERBUFFER_NV"},
    {0x9547,"GL_QUERY_RESOURCE_BUFFEROBJECT_NV"},
    ...
    {0x92BB,"GL_PURGED_CONTEXT_RESET_NV"},
    ...
    {0x9555,"GL_SCISSOR_TEST_EXCLUSIVE_NV"},
    {0x9556,"GL_SCISSOR_BOX_EXCLUSIVE_NV"},
    {0x8F1D,"GL_BUFFER_GPU_ADDRESS_NV"},
    {0x8F34,"GL_GPU_ADDRESS_NV"},
    {0x8F35,"GL_MAX_SHADER_BUFFER_ADDRESS_NV"},
    {0x9339,"GL_WARP_SIZE_NV"},
    {0x933A,"GL_WARPS_PER_SM_NV"},
    {0x933B,"GL_SM_COUNT_NV"},
    {0x9563,"GL_SHADING_RATE_IMAGE_NV"},
    {0x9564,"GL_SHADING_RATE_NO_INVOCATIONS_NV"},
    {0x9565,"GL_SHADING_RATE_1_INVOCATION_PER_PIXEL_NV"},
    {0x9566,"GL_SHADING_RATE_1_INVOCATION_PER_1X2_PIXELS_NV"},
    {0x9567,"GL_SHADING_RATE_1_INVOCATION_PER_2X1_PIXELS_NV"},
    {0x9568,"GL_SHADING_RATE_1_INVOCATION_PER_2X2_PIXELS_NV"},
    {0x9569,"GL_SHADING_RATE_1_INVOCATION_PER_2X4_PIXELS_NV"},
    {0x956A,"GL_SHADING_RATE_1_INVOCATION_PER_4X2_PIXELS_NV"},
    {0x956B,"GL_SHADING_RATE_1_INVOCATION_PER_4X4_PIXELS_NV"},
    {0x956C,"GL_SHADING_RATE_2_INVOCATIONS_PER_PIXEL_NV"},
    {0x956D,"GL_SHADING_RATE_4_INVOCATIONS_PER_PIXEL_NV"},
    {0x956E,"GL_SHADING_RATE_8_INVOCATIONS_PER_PIXEL_NV"},
    {0x956F,"GL_SHADING_RATE_16_INVOCATIONS_PER_PIXEL_NV"},
    {0x955B,"GL_SHADING_RATE_IMAGE_BINDING_NV"},
    {0x955C,"GL_SHADING_RATE_IMAGE_TEXEL_WIDTH_NV"},
    {0x955D,"GL_SHADING_RATE_IMAGE_TEXEL_HEIGHT_NV"},
    {0x955E,"GL_SHADING_RATE_IMAGE_PALETTE_SIZE_NV"},
    {0x955F,"GL_MAX_COARSE_FRAGMENT_SAMPLES_NV"},
    {0x95AE,"GL_SHADING_RATE_SAMPLE_ORDER_DEFAULT_NV"},
    {0x95AF,"GL_SHADING_RATE_SAMPLE_ORDER_PIXEL_MAJOR_NV"},
    {0x95B0,"GL_SHADING_RATE_SAMPLE_ORDER_SAMPLE_MAJOR_NV"},
    ...
    {0x936E,"GL_UNIFORM_BUFFER_UNIFIED_NV"},
    {0x936F,"GL_UNIFORM_BUFFER_ADDRESS_NV"},
    {0x9370,"GL_UNIFORM_BUFFER_LENGTH_NV"},
    ...
    {0x83A4,"GL_RGBA_DXT5_S3TC"},
    {0x83A5,"GL_RGBA4_DXT5_S3TC"},
    {0x80EA,"GL_PHONG_WIN"},
    {0x80EB,"GL_PHONG_HINT_WIN"},
    {0x80EC,"GL_FOG_SPECULAR_TEXTURE_WIN"},
    };
    if(enumLUT.count(type) == 0)
        return std::string("<GLenum ")+std::to_string(type)+ std::string(">");
    return enumLUT.at(type);
}
